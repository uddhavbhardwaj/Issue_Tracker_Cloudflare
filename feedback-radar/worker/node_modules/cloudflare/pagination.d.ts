...
export declare namespace CursorPaginationAfterResponse {
    interface ResultInfo {
...
export declare class CursorPaginationAfter<Item> extends AbstractPage<Item> implements CursorPaginationAfterResponse<Item> {
    result: Array<Item>;
    result_info: CursorPaginationAfterResponse.ResultInfo;
    constructor(client: APIClient, response: Response, body: CursorPaginationAfterResponse<Item>, options: FinalRequestOptions);
    getPaginatedItems(): Item[];
