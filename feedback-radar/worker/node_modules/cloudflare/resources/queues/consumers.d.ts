...
export declare class Consumers extends APIResource {
     ...
     * ```
     */
    list(queueId: string, params: ConsumerListParams, options?: Core.RequestOptions): Core.PagePromise<ConsumersSinglePage, Consumer>;
    /**
     ...
     * ```
     */
    get(queueId: string, consumerId: string, params: ConsumerGetParams, options?: Core.RequestOptions): Core.APIPromise<Consumer>;
}
...
export declare namespace Consumers {
    export { type Consumer as Consumer, type ConsumerDeleteResponse as ConsumerDeleteResponse, ConsumersSinglePage as ConsumersSinglePage, type ConsumerCreateParams as ConsumerCreateParams, type ConsumerUpdateParams as ConsumerUpdateParams, type ConsumerListParams as ConsumerListParams, type ConsumerDeleteParams as ConsumerDeleteParams, type ConsumerGetParams as ConsumerGetParams, };
}
