...
export declare class CAsV4PagePaginationArray extends V4PagePaginationArray<CA> {
}
export interface CA {
    /**
     * The ID of the CA.
...
export declare namespace CAs {
    export { type CA as CA, type CADeleteResponse as CADeleteResponse, CAsV4PagePaginationArray as CAsV4PagePaginationArray, type CACreateParams as CACreateParams, type CAListParams as CAListParams, type CADeleteParams as CADeleteParams, type CAGetParams as CAGetParams, };
}
