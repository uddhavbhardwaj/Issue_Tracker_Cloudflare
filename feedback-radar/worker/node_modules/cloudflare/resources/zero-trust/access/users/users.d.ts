...
export declare class Users extends APIResource {
     ...
     * ```
     */
    list(params: UserListParams, options?: Core.RequestOptions): Core.PagePromise<UserListResponsesV4PagePaginationArray, UserListResponse>;
}
export declare class UserListResponsesV4PagePaginationArray extends V4PagePaginationArray<UserListResponse> {
}
export declare class AccessUsersV4PagePaginationArray extends V4PagePaginationArray<AccessUser> {
}
...
export declare namespace Users {
    export { type AccessUser as AccessUser, type UserListResponse as UserListResponse, UserListResponsesV4PagePaginationArray as UserListResponsesV4PagePaginationArray, type UserListParams as UserListParams, };
