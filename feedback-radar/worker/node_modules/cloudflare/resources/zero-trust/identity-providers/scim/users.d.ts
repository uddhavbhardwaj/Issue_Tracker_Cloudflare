...
import { AccessUsersV4PagePaginationArray } from "../../access/users/users.js";
...
export declare class Users extends APIResource {
     ...
     * ```
     */
    list(identityProviderId: string, params: UserListParams, options?: Core.RequestOptions): Core.PagePromise<AccessUsersV4PagePaginationArray, UsersAPI.AccessUser>;
}
