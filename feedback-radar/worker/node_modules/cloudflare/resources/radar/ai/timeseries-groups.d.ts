...
export declare class TimeseriesGroups extends APIResource {
     ...
     * ```
     */
    summary(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL', query?: TimeseriesGroupSummaryParams, options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupSummaryResponse>;
    summary(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL', options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupSummaryResponse>;
    /**
     ...
     * ```
     */
    timeseriesGroups(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL', query?: TimeseriesGroupTimeseriesGroupsParams, options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupTimeseriesGroupsResponse>;
    timeseriesGroups(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL', options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupTimeseriesGroupsResponse>;
    /**
