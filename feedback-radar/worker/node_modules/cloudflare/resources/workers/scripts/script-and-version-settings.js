...
class ScriptAndVersionSettings extends resource_1.APIResource {
    ...
    edit(scriptName, params, options) {
        ...
        return this._client.patch(`/accounts/${account_id}/workers/scripts/${scriptName}/settings`, Core.multipartFormRequestOptions({ body, ...options, __multipartSyntax: 'json' }))._thenUnwrap((obj) => obj.result);
    }
    /**
