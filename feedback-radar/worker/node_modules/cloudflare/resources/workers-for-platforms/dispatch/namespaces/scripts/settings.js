...
class Settings extends resource_1.APIResource {
    ...
    edit(dispatchNamespace, scriptName, params, options) {
        ...
        return this._client.patch(`/accounts/${account_id}/workers/dispatch/namespaces/${dispatchNamespace}/scripts/${scriptName}/settings`, Core.multipartFormRequestOptions({ body, ...options, __multipartSyntax: 'json' }))._thenUnwrap((obj) => obj.result);
    }
    /**
