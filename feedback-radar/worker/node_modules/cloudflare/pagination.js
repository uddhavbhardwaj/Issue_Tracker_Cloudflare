...
exports.SinglePage = exports.CursorLimitPagination = exports.CursorPaginationAfter = exports.CursorPagination = exports.V4PagePaginationArray = exports.V4PagePagination = void 0;
...
class CursorPaginationAfter extends core_1.AbstractPage {
    constructor(client, response, body, options) {
        super(client, response, body, options);
        this.result = body.result || [];
        this.result_info = body.result_info || {};
...
exports.CursorPaginationAfter = CursorPaginationAfter;
