...
// .wrangler/tmp/bundle-GGmfMS/checked-fetch.js
...
// .wrangler/tmp/bundle-GGmfMS/strip-cf-connecting-ip-header.js
...
__name(FeedbackWorkflow, "FeedbackWorkflow");
...
app.post("/api/seed", async (c) => {
  ...
  return c.json({ message: "Seeded successfully (Background processing started)", results });
});
...
app.get("/api/feedback/:id/similar", async (c) => {
  ...
  const matches = await c.env.VECTORIZE_INDEX.query(vector, { topK: 5, returnMetadata: true });
...
// .wrangler/tmp/bundle-GGmfMS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-GGmfMS/middleware-loader.entry.ts
